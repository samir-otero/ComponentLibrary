...
import { Table, TableHeader, TableRowComponent, TableCell, TableFooter } from './Table';
...
describe('TableFooter Component', () => {
  ...
  test('spans correct number of columns', () => {
    render(
      <table>
        <TableFooter columnsCount={5}>
          Footer spanning 5 columns
        </TableFooter>
      </table>
    );
