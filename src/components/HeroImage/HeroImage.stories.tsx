...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A hero image component with overlay text, customizable positioning, and responsive design.",
      },
    },
  },
  tags: ["autodocs"],
...
export const ResponsiveShowcase: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "This hero image automatically adjusts its height on smaller screens",
      },
    },
  },
};
