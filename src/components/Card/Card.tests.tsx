...
describe('Card Component', () => {
  ...
  test('renders card with title and subtitle', () => {
    ...
    render(<Card title={title} subtitle={subtitle}>Card Content</Card>);
  ...
  test('does not call onClick handler when disabled clickable card is clicked', () => {
    ...
    const cardElement = screen.getByText('Disabled Clickable Card').closest('div');
    fireEvent.click(cardElement!);
  ...
  test('handles keyboard interaction for clickable cards', () => {
    ...
    const cardElement = screen.getByText('Keyboard Accessible Card').closest('div');
