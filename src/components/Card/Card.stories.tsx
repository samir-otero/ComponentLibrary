...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A flexible card component with multiple variants, sizes, and states. Perfect for displaying content in a structured format.",
      },
    },
  },
  tags: ["autodocs"],
...
export const Default: Story = {
  args: {
    ...
    children:
      "This is the main content of the card. It can contain any React elements including text, buttons, forms, and more.",
  },
};
...
export const WithoutHeader: Story = {
  args: {
    children:
      "This card has no title or subtitle, just content. Perfect for simple layouts.",
  },
};
...
export const WithImage: Story = {
  args: {
    ...
    children:
      "This card includes an image at the top, perfect for photo galleries or product showcases.",
  },
};
...
export const Large: Story = {
  args: {
    ...
    size: "large",
    children:
      "This is a large card suitable for detailed content and larger layouts.",
  },
};
...
export const CustomBorderRadius: Story = {
  args: {
    ...
    borderRadius: "20px",
    children:
      "This card has a custom border radius for a more rounded appearance.",
  },
};
...
export const AllElevations: Story = {
  ...
  render: (args) => (
    ...
    >
      <Card {...args} elevation="none" title="No Elevation">
        No shadow
      </Card>
      <Card {...args} elevation="low" title="Low Elevation">
        Low shadow
      </Card>
      <Card {...args} elevation="default" title="Default Elevation">
        Default shadow
      </Card>
      <Card {...args} elevation="medium" title="Medium Elevation">
        Medium shadow
      </Card>
      <Card {...args} elevation="high" title="High Elevation">
        High shadow
      </Card>
    </div>
  ),
