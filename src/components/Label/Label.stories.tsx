...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A flexible label component with multiple variants, sizes, and states for form elements and content labeling.",
      },
    },
  },
  tags: ["autodocs"],
...
export const AllVariants: Story = {
  ...
  render: (args) => (
    ...
    >
      <Label {...args} variant="primary">
        Primary
      </Label>
      <Label {...args} variant="secondary">
        Secondary
      </Label>
      <Label {...args} variant="success">
        Success
      </Label>
      <Label {...args} variant="danger">
        Danger
      </Label>
      <Label {...args} variant="warning">
        Warning
      </Label>
      <Label {...args} variant="info">
        Info
      </Label>
    </div>
  ),
