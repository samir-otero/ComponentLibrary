...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A flexible text component with multiple variants, sizes, weights, and styling options for various content types.',
      },
    },
  },
  tags: ['autodocs'],
...
export const JustifyAlign: Story = {
  args: {
    children: 'This text is justified and will align to both left and right margins when it wraps to multiple lines, creating a clean block appearance.',
    align: 'justify',
    fullWidth: true,
  },
  parameters: {
...
export const Paragraph: Story = {
  args: {
    children: 'This is a paragraph element with some longer text content that demonstrates how the component works as a block-level element.',
    as: 'p',
  },
  parameters: {
    layout: 'padded',
...
export const Truncated: Story = {
  args: {
    children: 'This is a very long text that will be truncated with an ellipsis when it exceeds the available width',
    truncate: true,
  },
  parameters: {
    layout: 'padded',
...
export const AllSizes: Story = {
  ...
  render: (args) => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', alignItems: 'flex-start' }}>
      <Text {...args} size="xs">Extra Small Text</Text>
      <Text {...args} size="small">Small Text</Text>
      <Text {...args} size="medium">Medium Text</Text>
      <Text {...args} size="large">Large Text</Text>
      <Text {...args} size="xl">Extra Large Text</Text>
      <Text {...args} size="2xl">Double Extra Large Text</Text>
    </div>
  ),
  parameters: {
    docs: {
...
export const AllVariants: Story = {
  ...
  render: (args) => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', alignItems: 'flex-start' }}>
      <Text {...args} variant="primary">Primary Text</Text>
      <Text {...args} variant="secondary">Secondary Text</Text>
      <Text {...args} variant="success">Success Text</Text>
      <Text {...args} variant="danger">Danger Text</Text>
      <Text {...args} variant="warning">Warning Text</Text>
      <Text {...args} variant="info">Info Text</Text>
      <Text {...args} variant="muted">Muted Text</Text>
    </div>
  ),
  parameters: {
    docs: {
