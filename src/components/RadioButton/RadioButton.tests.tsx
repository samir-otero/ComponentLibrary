...
describe('RadioButton Component', () => {
  ...
  test('changes background color when component is in disabled state', () => {
    render(<RadioButton label="Disabled Radio" name="test" value="test" disabled />);
    const radioElement = screen.getByRole('radio');
  ...
  test('renders checked radio button', () => {
    render(<RadioButton label="Checked Radio" name="test" value="test" checked />);
    const radioElement = screen.getByRole('radio');
    expect(radioElement).toBeChecked();
  });

  test('renders with correct size', () => {
    render(<RadioButton label="Large Radio" name="test" value="test" size="large" />);
    const radioElement = screen.getByRole('radio');
    expect(radioElement).toBeInTheDocument();
  });
